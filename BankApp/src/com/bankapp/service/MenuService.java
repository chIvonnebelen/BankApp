...
import com.bankapp.exception.ExceptApp;
...
public class MenuService {
            ...
            try {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        userService.showUser(customers);
                        break;
                    case 4:
    ...
    //    System.out.println("2. First Deposi"); Dentro de crear menu para el usuario
        ...
        switch (numValitor) {
            case 1:
                ...
                bankAccountService.actualBalance(bankAccount);
//                user.getAccounts();
            ...
            case 3:
                ...
                bankAccountService.transfer(user.getAccounts().get(0));
                for( BankAccount account : user.getAccounts()){
                    System.out.println(account.getCbu()+"-- "+ account.getBalance());
                }
                break;
    ...
    public  void inicialiarDatos(ArrayList<User> customers){
...
//        customers.add(user8);
//        customers.add(user9);
//        customers.add(user10);
       //user1.getAccounts().add(new BankAccount (user1,9999, 100.00);
        BankAccount account1 = new BankAccount (user1,6789, 700.00);
        BankAccount account2 = new BankAccount (user2,1418, 3000.00);
        BankAccount account3 = new BankAccount (user3 , 1578, 500.00);
